...
if ($data['is_standalone_payment'] == true) {
    ...
    "<div style='width: 100%; height: 100vh; display: flex; flex-direction: column; flex-wrap: nowrap; justify-content: center; align-items: center;'>"
        . "<h1 style='width:100%; font-size:30px; text-align : center;'>لم يتم تأكيد عملية الدفع برجاء التواصل مع الرقم التالي لتأكيد عملية الدفع من خلال الواتس اب لتنسيق موعد الأستشارة</h1>"
