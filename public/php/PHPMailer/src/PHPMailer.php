...
class PHPMailer
{
     ...
     * the HTML refers to using the `$cid` value in `img` tags, for example `<img loading="lazy" alt="israaosman" src="cid:mylogo">`.
     * Never use a user-supplied path to a file!
     *
     * @param string $path        Path to the attachment
     ...
     * $basedir is prepended when handling relative URLs, e.g. <img loading="lazy" alt="israaosman" src="/images/a.webp"> and must not be empty
